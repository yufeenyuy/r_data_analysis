...
special100 %>%
  ...
  labs(y = "Produzierter Betrag", title = "Zeitrheihe auf Saisonalität graphisch prüfen") +
  theme_classic()
```
...
special100_log %>%
  ...
  labs(y = "log(produzierter Betrag) in GE", x = "Woche", 
...
special100_log_diff %>%
  ...
  labs(y = "log(produzierter Betrag) in GE" ,title = "Stabilisierte Varianz und Mittelwert") +
  theme_classic() + 
  theme(
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1)
...
arima_model %>% 
  ...
  labs(y = "Log transformierte Beträge (GE)", x = "Woche", title = "Log transformierte Werte + forecast") +
  theme_classic() +
  theme(
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1)
...
special100_fc %>% autoplot(special100_log, level = NULL) +
  ...
  guides(color = guide_legend(title = "vorhersagen")) +
  theme_classic() +
  theme(
    plot.title = element_text(hjust = 0.5),
    axis.text.x = element_text(angle = 45, hjust = 1)
...
ggplot() +
  geom_line(data = special100_log, aes(x = weekly, y = log_week_amount), color = "black") +
  geom_line(data = fct, aes(x = weekly, y = .expmean), color = "blue") +
  #geom_ribbon(data = fct, aes(x = weekly, ymin = .lower, ymax = .upper), alpha = 0.2, fill = "blue") +
